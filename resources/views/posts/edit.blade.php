...
<form method="POST" action="/posts/{{$post->id}}">
    @csrf
    @method('PATCH')
    <h5><strong>Modify the post</strong></h5>
    <input name="title" placeholder="Title" class="name" value="{{ $post->title }}" />
    <textarea rows=" 4" cols="50" name="body" placeholder="Body" class="message">{{ $post->body }}</textarea>
    <input name="submit" class="btn" type="submit" value="Modify" />
</form>
@endcan
@stop