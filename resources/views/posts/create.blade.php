...
<form method="POST" action="/posts">
    @csrf
    <input name="title" placeholder="Title" class="name" required />
    <textarea rows="4" cols="50" name="body" placeholder="Body" class="message" required></textarea>
    <input name="submit" class="btn" type="submit" value="Publish" />
</form>
@stop